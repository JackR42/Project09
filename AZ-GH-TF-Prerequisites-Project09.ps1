...
$resourceGroupNameCore = $Prefix+"CORE"
...
## Don't create, use existing S2-RG-CORE 
...
$null = az keyvault secret set --vault-name $kvName --name "SQLServer-InstanceAdminUserName" --value 'Admin42'
